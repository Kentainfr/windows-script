...
<?php
  ...
  $reponse = $bdd->query('SELECT * FROM windows_settings');
...
<div class="desktop" style="background-image: url(<?php echo $data['fond_ecran']; ?>);">
  <a class="taskbar__item taskbar__item--game" href="#" data-window="game"><img class="icon" src="<?php echo $data['img_application_game']; ?>"></a><br>
  <a class="taskbar__item taskbar__item--block" href="#" data-window="block"><img class="icon" src="<?php echo $data['img_application_block']; ?>"></a><br>
  ...
  <a class="taskbar__item taskbar__item--lspdpresentation" href="#" data-window="lspdpresentation"><img class="icon" src="<?php echo $data['img_application_lspd_presentation']; ?>"></a><br>
  ...
  <div class="window window--notepad" data-window="notepad" style="display:none;width:600px;height:300px;top:10%;left:30%;">
   ...
   <?php
    ...
    <div class="window window--game" data-window="game" style="display:none;width:1200px;height:800px;top:10%;left:30%;">
       <div class="window__titlebar">
         <div class="window__controls window__controls--left">
           <a class="window__icon" href="#"><i class="fa fa-pencil"></i></a>
           <a class="window__menutoggle" href="#"><i class="fa fa-bars"></i></a>
  ...
  ?>
   ...
   <?php
    ...
    <?php
      ...
      while ($data = $reponse->fetch()) {
      ?>
           <iframe src="<?php echo $data['url_windows']; ?>/modules/game" style="width:100%;height:100%;border: none;"></iframe>
...
<div class="window window--block" data-window="block" style="display:none;width:1200px;height:800px;top:10%;left:30%;">
   <div class="window__titlebar">
     <div class="window__controls window__controls--left">
       <a class="window__icon" href="#"><i class="fa fa-pencil"></i></a>
       <a class="window__menutoggle" href="#"><i class="fa fa-bars"></i></a>
...
<?php
  ...
  while ($data = $reponse->fetch()) {
  ?>
       <iframe src="<?php echo $data['url_windows']; ?>/modules/block" style="width:100%;height:100%;border: none;"></iframe>
<?php } $reponse->closeCursor(); ?>
     </div>
   </div>
...
<div class="window window--lspdpresentation" data-window="lspdpresentation" style="display:none;width:1200px;height:800px;top:10%;left:30%;">
   <div class="window__titlebar">
     <div class="window__controls window__controls--left">
       <a class="window__icon" href="#"><i class="fa fa-pencil"></i></a>
       <a class="window__menutoggle" href="#"><i class="fa fa-bars"></i></a>
...
<?php
  ...
  while ($data = $reponse->fetch()) {
  ?>
       <iframe src="<?php echo $data['url_windows']; ?>/modules/lspd-presentation" style="width:100%;height:100%;border: none;"></iframe>
<?php } $reponse->closeCursor(); ?>
     </div>
   </div>
