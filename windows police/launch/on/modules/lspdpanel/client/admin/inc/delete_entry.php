...
if(isset($_POST['deleterecrutement']) and is_numeric($_POST['deleterecrutement']))
{
  $id = $_POST['deleterecrutement'];
  $count=$bdd->prepare("DELETE FROM lspd_recrutement WHERE id=:id");
  $count->bindParam(":id",$id,PDO::PARAM_INT);
  $count->execute();
